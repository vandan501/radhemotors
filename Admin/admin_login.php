<!-- <?php
    ...
    if(count($_POST)>0) {
        ...
        $result = mysqli_query($con,"SELECT * FROM admin WHERE a_email='" . $_POST["a_email"] . "' and a_password = '". $_POST["a_password"]."'");
    ...
    header("Location:http://localhost/radhemotors/admin/admin_Dashboard.php");
    }
?>
...
<html lang="en">
  <head>
    ...
    <!-- Title -->
    <title>Radhe Motors | Admin Login</title>

    <!-- Title image  -->
    <link rel="icon" href="./Images/radhe_logo.ico" type="image/x-icon" />
    ...
    <form method="POST">
      <div class="login">
        ...
        <form method="post">
          ...
          <br />
          <center>
            <a href="forgotpasswordadmin.php" style="color: white"
              >forgot password</a
            >
          </center>
        </form>
